          ...
          <div className="container-x">
            <div className="glass flex items-center justify-between rounded-2xl px-5 py-3.5">
              ...
              <nav className="flex items-center gap-7 text-sm text-white/80">
                <a href="#services" className="hover:text-white hidden sm:inline">服务</a>
                <a href="#cases" className="hover:text-white hidden sm:inline">案例</a>
                <a href="#contact" className="hover:text-white hidden sm:inline">联系</a>
                <a href="#contact" className="sm:hidden inline-block rounded-md border border-white/15 px-3 py-1.5">联系</a>
              </nav>
            </div>
          </div>
        </header>
